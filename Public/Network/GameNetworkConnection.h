...
DECLARE_DELEGATE(FOnGameNetworkConnectionStateChanged)

class PLATFORMARCHITECTRUNTIME_API FGameNetworkConnection
	: public FRunnable
	, public TSharedFromThis<FGameNetworkConnection>
{
public:
	/** Connection state */
	...
	*/
	FGameNetworkConnection(FSocket* InSocket, const FIPv4Endpoint& InRemoteEndpoint, int32 InConnectionRetryDelay, IGameNetworkMessageFactoryPtr InMessageFactory);

	/** Virtual destructor. */
	virtual ~FGameNetworkConnection();
	...
	* @see Send
	*/
	bool Receive(FGameNetworkMessagePtr& OutMessage, FGuid& OutSenderNodeId);
	...
	*/
	FOnGameNetworkConnectionStateChanged& OnConnectionStateChanged()
	{
...
private:
	...
	FOnGameNetworkConnectionStateChanged ConnectionStateChangedDelegate;
	...
	TQueue<FGameNetworkMessagePtr, EQueueMode::Mpsc> Inbox;
